      ...
      <section className="mx-auto max-w-4xl p-4">
        ...
        <ul>
          <li>
            ...
            or interact with our services, we may collect personal information
            such as your name, email address, timezone and language preferences.
          </li>
          <li>
            <strong>Usage Data:</strong> We collect non-personally identifiable
            information about how you interact with our website, such as your IP
            address, browser type, the pages you visit, and the time you spend
            on the site.
          </li>
          <li>
            <strong>Cookies:</strong> We use cookies and similar tracking
            technologies to enhance your experience. Cookies help us track your
            usage patterns and improve our services. You can control cookie
        ...
        <ul>
          <li>To provide and improve our language learning services.</li>
          ...
          <li>
            To personalize your experience based on your language preferences.
          </li>
          <li>
            To analyze website traffic and improve our website functionality.
          </li>
        </ul>
        ...
        <ul>
          <li>
            ...
            website, processing payments, and providing customer support, as
          ...
          <li>
            ...
            necessary to comply with legal processes, enforce our terms, or
        ...
        <p>
          ...
          become aware that a child under 13 has provided us with personal data,
          we will take steps to delete such information.
        </p>

        <h2>7. International Transfers</h2>
        <p>
          If you are accessing <strong>https://mywords.pro</strong> from outside
          our operating country, your information may be transferred to and
          processed in a different country where data protection laws may
        ...
        <p>
          ...
          you would like to exercise your data rights, please contact us at{' '}
          <strong>mywords.pro@gmail.com</strong>.
        </p>
      </section>
    </div>
  );

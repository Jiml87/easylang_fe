              ...
              <div className="justify-center md:flex md:flex-col">
                <div className="text-green-800 md:max-w-lg">
                  ...
                  <div className="pt-2 text-sm sm:text-base">
                    ...
                    schedule reminders to review it on the 1st, 3rd, 7th, and
                    30th day. Plus, with smart AI-driven tasks, you&lsquo;ll
                    practice using the word in context, making it easier to
